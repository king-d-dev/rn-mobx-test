...
export const ErrorComponent = (props: ErrorComponentProps) => {
  return (
    <View style={CONTAINER}>
      ...
      <Text style={TITLE_ERROR} text={"errorScreen.title"} />
      <Text style={FRIENDLY_SUBTITLE} text={"errorScreen.friendlySubtitle"} />
      ...
      <Button style={BTN_RESET} onPress={props.onReset} text="errorScreen.reset" />
    </View>
  )
}
